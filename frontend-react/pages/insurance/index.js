    ...
    <>
      ...
      <div className="container">
        ...
        >
          ...
          <div className={`text-end ${styles.row}`}>
            <div className="col-12 col-md-2 order-1 order-md-2 text-center">
              <Image
                src="/img/insurance/2.png"
                className={styles.img_responsive}
                width={200}
                height={200}
                alt="描述圖片內容"
